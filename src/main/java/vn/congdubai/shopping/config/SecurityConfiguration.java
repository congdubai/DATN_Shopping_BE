...
public class SecurityConfiguration {
    ...
    @Value("${congdubai.jwt.base64-secret}")
    ...
    public SecurityFilterChain filterChain(
        ...
        String[] whiteList = {
                "/",
                "/api/v1/auth/login", "/api/v1/auth/refresh", "/api/v1/auth/register", "/api/v1/files",
                "/storage/**",
                "/api/v1/email/**",
                "/v3/api-docs/**",
                "/swagger-ui/**",
                ...
                "/api/v1/review", "/api/v1/list-categories", "/api/v1/orders", "/data/**"
